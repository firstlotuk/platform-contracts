# Graph Report - platform-contracts  (2026-09-07)
...
## Summary
- 1343 nodes · 2070 edges · 97 communities (81 shown, 16 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7181afb4`
...
- `required` --extends--> `taxYear`  [EXTRACTED]
  schemas/stateless-calculation-request/1.0.0/schema.json → schemas/filing-contribution-pack/1.0.0/schema.json
- `required` --extends--> `version`  [EXTRACTED]
  schemas/stateless-calculation-result/1.0.0/schema.json → schemas/filing-contribution-pack/1.0.0/schema.json
- `required` --extends--> `rateJurisdiction`  [EXTRACTED]
  schemas/stateless-calculation-request/1.0.0/schema.json → schemas/stateless-calculation-result/1.0.0/schema.json
- `required` --extends--> `rulesetVersion`  [EXTRACTED]
  schemas/stateless-calculation-request/1.0.0/schema.json → schemas/stateless-calculation-result/1.0.0/schema.json
...
Cohesion: 0.13
Nodes (15): $ref, properties, $ref, $ref, foreignTaxCredit, netIncomeTaxDue, nonSavingsTax, savingsTax (+7 more)

### Community 4 - "required"
Cohesion: 0.05
Nodes (39): bands, dividendTax, foreignTaxCredit, netIncomeTaxDue, nonSavingsTax, payeDeducted, personalAllowance, savingsTax (+31 more)

### Community 5 - "consent.ts"
Cohesion: 0.09
Nodes (38): CONSENT_ACTION_RECONCILIATION_MAP, CONSENT_ACTIONS, CONSENT_AUDIT_EVENTS, CONSENT_AUTH_LEVELS, CONSENT_CACHE_SLA, CONSENT_EVENT_KINDS, CONSENT_KIND_ACTION_POLICY, CONSENT_KINDS (+30 more)

### Community 6 - "properties"
Cohesion: 0.12
Nodes (17): type, type, type, type, properties, type, type, type (+9 more)

### Community 7 - "schema.json"
Cohesion: 0.05
Nodes (37): contentHash, generatedAt, name, packId, packPayload, additionalProperties, $ref, description (+29 more)
...
### Community 13 - "enum"
Cohesion: 0.06
Nodes (36): additional, allowance, basic, bucket, higher, psa, rate, starter (+28 more)
...
Cohesion: 0.04
Nodes (47): engineVersion, exclusions, formInputs, inputHash, result, scottish, specials, warnings (+39 more)

### Community 16 - "schema.json"
Cohesion: 0.06
Nodes (31): additionalProperties, description, description, minLength, type, description, items, type (+23 more)
...
Cohesion: 0.18
Nodes (11): jest-environment-node, json-schema-to-typescript, devDependencies, jest-environment-node, json-schema-to-typescript, ts-jest, @types/jest, typescript (+3 more)
...
Cohesion: 0.08
Nodes (25): employmentGbp, foreignDividendsGbp, foreignInterestGbp, foreignTaxCreditGbp, giftAidGbp, otherIncomeGbp, payeDeductedGbp, pensionContributionGbp (+17 more)
...
### Community 55 - "enum"
Cohesion: 0.20
Nodes (10): advanced, intermediate, top, enum, additional, allowance, basic, higher (+2 more)

### Community 56 - "required"
Cohesion: 0.20
Nodes (10): dividends, nonSavings, savings, additionalProperties, required, type, dividends, nonSavings (+2 more)
...
Cohesion: 0.50
Nodes (4): formInputs, additionalProperties, description, type

### Community 67 - "jest"
Cohesion: 0.67
Nodes (3): jest, jest, jest
...
## Knowledge Gaps
- **629 isolated node(s):** `name`, `version`, `description`, `private`, `sideEffects` (+624 more)
...
- **Why does `$defs` connect `$defs` to `contributionValue`, `state`, `sha256`, `presentValue`, `schema.json`, `producerProvenance`, `properties`, `instant`, `reviewSignal`, `reviewSignals`, `contractIdentity`, `versionedArtifact`, `notApplicableValue`, `producerBuild`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `required` connect `required` to `properties`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `packPayload` connect `properties` to `$defs`?**
