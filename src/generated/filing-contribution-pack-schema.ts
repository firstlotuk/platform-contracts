...
export const FILING_CONTRIBUTION_PACK_V1_SCHEMA_ID = "https://contracts.firstlot.co.uk/filing-contribution-pack/1.0.0/schema.json" as const;
export const FILING_CONTRIBUTION_PACK_V1_SCHEMA_VERSION = "1.0.0" as const;
export const FILING_CONTRIBUTION_PACK_V1_SCHEMA_HASH = "sha256:cfc2d0ed73d45ddddce3520b9b41e7aac8c9a1d0c2697705082337dbb4c7b8f2" as const;
export const FILING_CONTRIBUTION_PACK_V1_SCHEMA = {
...
export const FILING_CONTRIBUTION_PACK_V2_SCHEMA_ID = "https://contracts.firstlot.co.uk/filing-contribution-pack/2.0.0/schema.json" as const;
export const FILING_CONTRIBUTION_PACK_V2_SCHEMA_VERSION = "2.0.0" as const;
export const FILING_CONTRIBUTION_PACK_V2_SCHEMA_HASH = "sha256:f5d05450bdbbc6a9f4f3091e62f85a08b0f09dce2bef0576f258b109f9659e89" as const;
export const FILING_CONTRIBUTION_PACK_V2_SCHEMA = {
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://contracts.firstlot.co.uk/filing-contribution-pack/2.0.0/schema.json",
  "title": "FilingContributionPackEnvelope",
  "description": "Immutable, portable FirstLot filing contribution pack. Child-domain source data is deliberately excluded.",
  "type": "object",
  "additionalProperties": false,
  ...
  "$defs": {
    ...
    "contractIdentity": {
      ...
      "properties": {
        "schemaId": {
          "const": "https://contracts.firstlot.co.uk/filing-contribution-pack/2.0.0/schema.json"
        },
        "schemaVersion": {
          "const": "2.0.0"
        },
